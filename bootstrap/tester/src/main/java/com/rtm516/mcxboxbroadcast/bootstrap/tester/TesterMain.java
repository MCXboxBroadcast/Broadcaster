...
public class TesterMain {
    ...
    public static void main(String[] args) {
        ...
        ExpandedSessionInfo sessionInfo = new ExpandedSessionInfo("", "", new SessionInfo("", "", 0, 0, "", 0));
    ...
    private static void setupAuth() {
        ...
        authManager = new AuthManager(null, new FileStorageManager("./cache", "./screenshot.jpg"), logger);
