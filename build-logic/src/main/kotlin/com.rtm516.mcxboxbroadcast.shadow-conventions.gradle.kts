...
tasks {
    shadowJar {
        ...
        // libdatachannel limits us to glibc Linux x86_64/aarch64, Windows x86_64/aarch64 and macOS x86_64/arm64
        ...
        listOf(
            ...
            "sunos-sparcv9", "sunos-x86", "sunos-x86-64", "win32-x86"
